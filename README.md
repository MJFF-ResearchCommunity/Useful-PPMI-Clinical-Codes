...
1 - MDS-UPDRS Longitudinal Deltas & Minimal Clinically Important Difference Helper - Ana Jimena Hernández Medrano ([@jimenahmedrano](https://github.com/jimenahmedrano))
2 - PPMI harmonization based on enrollment criterias and protocol versions - Hirotaka Iwaki ([@hirotakai](https://github.com/hirotaka-i))
